...
The primary executable code and development walkthrough are contained within the `source_code_report_anshu_kumar_mandal_IIT_Mandi.ipynb` file.

1.  **Upload to Colab:** Open Google Colab and upload/open the `source_code_report_anshu_kumar_mandal_IIT_Mandi.ipynb`
...
The `source_code_report_anshu_kumar_mandal_IIT_Mandi.ipynb` file also contains the detailed walkthrough and code for the QLoRA fine-tuning process of the `microsoft/phi-2` model.
...
├── notebooks/
│   └── source_code_report_anshu_kumar_mandal_IIT_Mandi.ipynb # Detailed development log & primary execution walkthrough
├── scripts/
